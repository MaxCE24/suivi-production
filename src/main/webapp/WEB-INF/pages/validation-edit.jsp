...
<title>Page de modification de validation</title>
</head>
<body>
	<h1>Page de modification de validation</h1>
	<form:form method="POST" commandName="validation"
		action="${pageContext.request.contextPath}/validation/edit/${validation.id}.html">
		<table>
			<tbody>
